...
export const SEO = {
  ...
  privacyPolicy: {
    title: "Privacy Policy | Henil Enterprise",
    description:
      "How Henil Enterprise collects, uses, and protects information submitted through this website, including RFQ and contact form inquiries.",
    path: "/privacy-policy",
  },
  terms: {
    title: "Terms of Use | Henil Enterprise",
    description:
      "The terms that apply to using this website and submitting inquiries or requests for quotation to Henil Enterprise.",
    path: "/terms",
  },
  cookiePolicy: {
    title: "Cookie Policy | Henil Enterprise",
    description:
      "How Henil Enterprise uses cookies on this website, including optional analytics cookies, and how to control them.",
    path: "/cookie-policy",
  },
};
