...
export const SEO = {
  ...
  products: {
    title: "Acrylic & Polycarbonate Products | Custom Acrylic Fabrication Ahmedabad",
    description:
      "Browse acrylic sheets, polycarbonate components, machine guards and custom fabricated parts from our Ahmedabad facility — every listing can also be built as a custom fabrication.",
    path: "/products",
  },
  capabilities: {
